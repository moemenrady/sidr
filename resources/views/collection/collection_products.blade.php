...
@section('style')
    <style>
        ...
        body {
            ...
            font-family: 'Arial', sans-serif; /* يمكن تغيير الخط حسب تفضيلك */
        }
        ...
        .collection-controls {
            ...
            padding: 10px 0;
            margin-bottom: 30px;
            border-bottom: 1px solid rgba(98, 70, 65, 0.1); /* خط خفيف لأسفل */
        }
        ...
        .product-grid {
            display: grid;
            grid-template-columns: repeat(2, 1fr); /* الافتراضي: 2 في الصف (لشاشات التابلت) */
            gap: 40px 20px;
        }
        ...
        .product-image-wrapper {
            position: relative;
            overflow: hidden;
            border-radius: 8px; /* حواف مستديرة للصور */
            height: 400px; /* ارتفاع ثابت للصور للحفاظ على التناسق */
        }
        ...
        .sale-badge {
            position: absolute;
            bottom: 10px;
            left: 10px; /* في اليمين إذا كانت اللغة عربية */
        ...
        .product-link {
            ...
            color: inherit; /* لضمان أن جميع النصوص داخل اللينك ترث لونها من الـ container */
            display: block;
        }
        ...
        .product-price {
            ...
            display: flex;
            flex-direction: column;
            align-items: flex-start; /* محاذاة لليسار، عكس اتجاه القراءة العربية */
            margin-top: 5px;
        }
        ...
        .current-price {
            color: var(--primary-color); /* السعر الحالي بلون الثيم الأساسي */
        }
        ...
        .choose-options-btn {
            ...
            padding: 12px 20px;
            margin-top: 15px;
            background-color: var(--bg-color); /* خلفية فاتحة */
            color: var(--button-border-color); /* لون النص والحد الغامق */
            border: 2px solid var(--button-border-color); /* حد غامق */
            border-radius: 30px; /* حواف مستديرة جداً */
            font-size: 1rem;
            font-weight: bold;
            cursor: pointer;
        ...
        .icon-filter:before {
            content: "\f0b0"; /* مثال لـ Font Awesome Filter Icon */
        ...
        <div class="collection-controls">
            <div class="controls-info">
                <button class="filter-sort-btn" aria-label="Filter and sort products">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 3.5H2l8.5 10.9V20l3-2.5v-3.6L22 3.5z"/></svg>
